...
const browserLocale = typeof navigator === 'undefined' ? 'uz' : navigator.language.toLowerCase().split('-')[0]
const storedLocale = typeof localStorage === 'undefined' ? null : localStorage.getItem(STORAGE_KEY)
const initialLocale: Locale = storedLocale === 'uz' || storedLocale === 'ru' || storedLocale === 'en'
  ? storedLocale
  : browserLocale === 'ru' || browserLocale === 'en' ? browserLocale : 'uz'
