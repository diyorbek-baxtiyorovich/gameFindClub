...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      meta: { title: 'Bookings', showBottomNav: true, hideHeader: true },
    },
    {
      path: '/venue/:slug/booking',
      name: 'booking',
      component: () => import('@/pages/booking/BookingPage.vue'),
      props: true,
      meta: { title: 'Booking', showBottomNav: false, showBackButton: true },
    },
    {
      path: '/history',
      name: 'history',
      ...
      children: [
        { path: '', redirect: { name: 'owner-dashboard' } },
        {
          ...
          meta: {
            ...
            showBottomNav: false,
            ownerTitleKey: 'owner.nav.dashboard',
          },
        },
        {
          path: 'venues',
        ...
        },
        {
          ...
          meta: {
            title: 'Create venue',
            showBottomNav: false,
            ownerShowBottomNav: false,
            hideOwnerHeader: true,
            ownerTitleKey: 'owner.action.add_venue',
          },
        },
        {
          path: 'venues/:id/edit',
          ...
          meta: {
            ...
            ownerShowBottomNav: false,
            hideOwnerHeader: true,
            ownerTitleKey: 'owner.venue.edit',
          },
        },
        {
          path: 'reviews',
          ...
          meta: {
            title: 'Owner reviews',
            showBottomNav: false,
            ownerTitleKey: 'owner.nav.reviews',
          },
        },
        {
          path: 'analytics',
          ...
          meta: {
            ...
            showBottomNav: false,
            ownerTitleKey: 'owner.nav.analytics',
          },
        },
      ],
    },
